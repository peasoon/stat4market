...
import htmlBeaty from "gulp-html-beautify";
...
const images = async () => {
  return gulp
    .src("./project/img/**/*.{jpg,jpeg,png,gif,webp,svg}")
    .pipe(plumber())
    .pipe(
      imagemin({
        progressive: true,
...
export const pugWatch1 = () => {
	gulp.watch("./project/*.pug", pug)
};
export const pugWatch2 = () => {
	gulp.watch("./project/pug/**/*.pug", pug)
};
